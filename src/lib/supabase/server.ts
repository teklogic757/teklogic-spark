...
import { getPublicAuthCookieOptions } from '@/lib/security-headers'
...
export async function createClient() {
    ...
    return createServerClient<Database>(
        ...
        {
            cookieOptions: getPublicAuthCookieOptions(),
            cookies: {
                getAll() {
 ...
 *
 * Approved public-deployment call sites are documented in
 * `docs/privileged-access.md`. New usages should be treated as a security review
 * item, not a convenience shortcut.
 *
