...
**Archive note (2026-03-07):** v1.1 was archived with accepted runtime verification gaps for `RATE-01` and `RATE-02` (see `.planning/phases/08-durable-abuse-controls/08-UAT.md`).
