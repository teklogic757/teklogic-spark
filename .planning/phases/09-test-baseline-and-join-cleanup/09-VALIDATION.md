...
| 9-02-01 | 02 | 2 | TEST-02 | unit | `npm run test -- --run src/lib/score.test.ts src/lib/dashboard-access.test.ts src/lib/submit-flow.test.ts` | OK | pending |
| 9-02-02 | 02 | 2 | TEST-02 | integration-lite | `npm run test:ci` | OK | pending |
